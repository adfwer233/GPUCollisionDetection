...
Ground::Ground(glm::vec3 t_center) { this->center = t_center; }
...
AxisAlignedBoundingBox Ground::getBoundingBox() {
  return {center.x - ground_size, center.x + ground_size, center.y, center.y,
          center.z - ground_size, center.z + ground_size};
}